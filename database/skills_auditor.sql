...
--
-- Host: localhost
-- Generation Time: Jul 12, 2024 at 10:47 AM
...
INSERT INTO `employee` (`id`, `username`, `password`, `system_role_id`, `job_role_id`, `first_name`, `surname`, `managed_by`) VALUES
...
ALTER TABLE `employee`
  ...
  ADD CONSTRAINT `employee_ibfk_2` FOREIGN KEY (`job_role_id`) REFERENCES `job_role` (`id`),
